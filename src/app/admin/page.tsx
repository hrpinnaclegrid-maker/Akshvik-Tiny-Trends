...
export default function AdminPage() {
  ...
  const handleAddSubmit = async (e: React.FormEvent) => {
    ...
    await addProduct({
      ...
      image: productForm.image || "https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?auto=format&fit=crop&w=600&q=80",
      images: imagesArray.length > 0 ? imagesArray : [productForm.image || "https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?auto=format&fit=crop&w=600&q=80"],
